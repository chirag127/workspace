 ...
 * `chirag127` org level (visibility=all). Idempotent — safe to re-run.
 *
 * Why: the migration to chirag127 (2026-06-22) pushed 61 secrets to the org
