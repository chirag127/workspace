...
description: 'Every ingester: idempotent, backfill-capable, 7-day auto-pause, bounded'
...
- [`repos/oriz/own/prod/apps/personal/oriz-cs-me-app/knowledge/decisions/ingester-contract.md`](ingester-contract.md) — original app-scoped version (in the oriz-cs-me-app submodule) with reference implementation skeleton
