...
description: "me.oriz.in publishes only numeric aggregates from the journal — entry count, streak, monthly word count. The journal text itself stays auth-gated at journal.oriz.in."
