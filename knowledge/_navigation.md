...
| Looking for | Read |
|---|---|
| **How to OPERATE this knowledge bundle as an AI agent** (start here on every session) | [`agent-rules/agent-minimum-context.md`](./agent-rules/agent-minimum-context.md) |
