...
| [`mirror-to-7-popular-alternatives-2026-06-28`](./decisions/architecture/ops/mirror-to-7-popular-alternatives-2026-06-28.md) | active | Mirror repos/own/* to 7 free, no-self-host GitHub alternatives (GitLab, Codeberg, Bitbucket, GitFlic, Azure DevOps, NotABug, Radicle) driven from the umbrella repo's GitHub Actions. |
...
| [`public-image-upload-tool`](./decisions/architecture/public-image-upload-tool.md) | active | Locked 2026-06-23. oriz-pixie-image-tools-app gets a public /upload page using the 7-host replicate pipeline (Cloudinary + ImageKit + imgbb + freeimage + GH Releases). Free tier: 5 uploads/day, requires sign-in + reCAPTCHA v3. Pro tier: ... |
