...
- [`repos/c127/own/prod/apps/personal/cs-me-app/knowledge/`](../repos/c127/own/prod/apps/personal/cs-me-app/knowledge/) — lifestream + 100-year strategy + age-gating + ingester contract (lives inside the cs-me-app submodule; moved from oriz-org → chirag127 on 2026-06-24, slug dropped the `oriz-` prefix)
