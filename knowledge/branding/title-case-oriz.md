...
description: Title-Case Oriz user-facing; lowercase oriz-* in code
tags: [decision, branding, capitalisation, naming]
timestamp: 2026-06-20
format_version: okf-v0.1
status: active
related:
  - branding/oriz-me-added-to-family.md
  - branding/repo-naming-suffixes.md
  - branding/keep-oriz-add-site-suffix.md
---
...
- [`branding/oriz-me-added-to-family.md`](./oriz-me-added-to-family.md) — sister branding decision (member-site naming).
- [`branding/repo-naming-suffixes.md`](./repo-naming-suffixes.md) — repo-slug rules; lowercase `oriz-<name>-<suffix>` lock unchanged.
- <!-- TODO: broken link, was [`branding/keep-oriz-add-site-suffix.md`](./keep-oriz-add-site-suffix.md) --> — original brand-vs-suffix split; refines.
- <!-- TODO: broken link, was [`branding/oriz-kit-package-name.md`](./oriz-kit-package-name.md) --> — `@chirag127/oriz-kit` npm name unchanged.
- [`branding/family-wide-privacy-page.md`](./family-wide-privacy-page.md) — privacy copy uses Title-Case "Oriz".
