...
description: 'Locked 2026-06-20: single canonical /privacy on oriz.in'
tags: [privacy, legal, branding, decisions, oriz-in, compliance]
timestamp: 2026-06-20
format_version: okf-v0.1
status: active
related:
  - services/business/legal/privacy-page
...
- **Source of truth** lives in
  `repos/oriz/own/prod/apps/personal/oriz-cs-me-app/src/content/legal/privacy.md` (apex site
  hosts oriz.in per
  [`branding/oriz-me-added-to-family.md`](./oriz-me-added-to-family.md)).
