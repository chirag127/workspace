...
status: active
supersedes: [branding/naming-policy-v5]
...
| Slug | Local path |
|---|---|
| `oriz-cs-me-app` | `repos/oriz/own/prod/apps/personal/oriz-cs-me-app` |
| `oriz-pages-blog-app` | `repos/oriz/own/prod/apps/content/oriz-pages-blog-app` |
| `oriz-roam-journal-app` | `repos/oriz/own/prod/apps/content/oriz-roam-journal-app` |
| `oriz-lore-app` | `repos/oriz/own/prod/apps/content/oriz-lore-app` |
| `oriz-financial-cards-app` | `repos/oriz/own/prod/apps/content/oriz-financial-cards-app` |
| `oriz-omni-post-app` | `repos/oriz/own/prod/apps/content/oriz-omni-post-app` |
| `oriz-ncert-app` | `repos/oriz/own/prod/apps/content/oriz-ncert-app` |
| `oriz-janaushdhi-app` | `repos/oriz/own/prod/apps/content/oriz-janaushdhi-app` |
| `oriz-portfolio-engine-app` | (apps) |
| `home-app` | `repos/oriz/own/prod/apps/hub/home-app` |

### Tool-app repos

| Slug | Local path |
|---|---|
| `oriz-slice-pdf-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-slice-pdf-tools-app` |
| `oriz-pixie-image-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-pixie-image-tools-app` |
| `oriz-paisa-finance-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-paisa-finance-tools-app` |
| `oriz-forge-dev-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-forge-dev-tools-app` |
| `oriz-scribe-text-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-scribe-text-tools-app` |
| `oriz-shift-convert-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-shift-convert-tools-app` |
| `oriz-grid-qr-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-grid-qr-tools-app` |
| `oriz-pivot-data-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-pivot-data-tools-app` |
| `oriz-echo-audio-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-echo-audio-tools-app` |
| `oriz-reel-video-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-reel-video-tools-app` |
| `oriz-rank-seo-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-rank-seo-tools-app` |
| `oriz-cipher-crypto-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-cipher-crypto-tools-app` |
| `oriz-vitals-health-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-vitals-health-tools-app` |
| `oriz-dice-random-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-dice-random-tools-app` |
| `oriz-paper-print-tools-app` | `repos/oriz/own/prod/apps/tools/oriz-paper-print-tools-app` |

### API repos

| Slug | Local path |
|---|---|
| `oriz-mmi-tickertape-mmi-api` | `repos/oriz/own/svc/api/oriz-mmi-tickertape-mmi-api` |
| `oriz-flow-fii-dii-activity-api` | `repos/oriz/own/svc/api/oriz-flow-fii-dii-activity-api` |
