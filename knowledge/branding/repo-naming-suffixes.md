...
description: Naming suffixes per repo type (-site, -bs-ext, -vsc-ext, -cli, -mcp)
tags: [naming, repo, packages, suffix, family, branding]
timestamp: 2026-06-21
format_version: okf-v0.1
status: active
related:
  - branding/keep-oriz-add-site-suffix
  - branding/oriz-me-added-to-family
  - branding/oriz-kit-package-name
...
- Site repos completed in the fourth pass: `pages-site` ? `blog-site`,
  ...
  [`runbooks/workflow/rename-repo.md`](../../runbooks/workflow/rename-repo.md) and the
