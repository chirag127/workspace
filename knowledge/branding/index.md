...
|---|---|
| <!-- TODO: broken link, was [keep-oriz-add-site-suffix.md](./keep-oriz-add-site-suffix.md) --> | Repos become `oriz-<name>-site` / `oriz-<name>-ext`; packages keep `@chirag127/oriz-*` |
| <!-- TODO: broken link, was [oriz-kit-package-name.md](./oriz-kit-package-name.md) --> | `@chirag127/oriz-kit` is the canonical kit package name |
...
| <!-- TODO: broken link, was [oriz-urls-to-md-site-empty-placeholder.md](./oriz-urls-to-md-site-empty-placeholder.md) --> | `oriz-urls-to-md-site` is an empty repo, a deliberate slug reservation for a future URL → Markdown scraper. DO NOT delete |
