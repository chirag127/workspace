...
description: "Add a new extension repo as a submodule under extensions/, set up the cross-store publish workflow (Chrome Web Store + Firefox Add-ons + Edge Add-ons), wire its landing-page slot on extensions.oriz.in, and bump the master pointer."
tags: [runbook, extension, submodule, chrome, firefox, edge]
...
- Auth setup complete per [`auth-setup.md`](./auth-setup.md).
...
- Auth prerequisites: [`./auth-setup.md`](./auth-setup.md)
