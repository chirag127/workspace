...
| [`mirror-all-hosts-setup.md`](hosting/mirror-all-hosts-setup.md) | **Current** one-time setup for the 5-host automatic mirror (GitLab, Codeberg, Bitbucket, GitFlic, Azure DevOps): token generation, pre-creating repos on all 5 hosts, storing org-level secrets, dry-run + first real run verification. See [`decisions/architecture/ops/mirror-to-5-popular-alternatives-2026-06-28.md`](../decisions/architecture/ops/mirror-to-5-popular-alternatives-2026-06-28.md) | User (token gen), agent (scripted repo creation + verify) |
