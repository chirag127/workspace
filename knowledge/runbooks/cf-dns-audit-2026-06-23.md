...
- API submodule CNAMEs at `projects/apis/*/CNAME` (19 files, GH Pages targets).
- `FAMILY_APPS`, `FAMILY_APIS` in `projects/npm-packages/astro-shell-npm-pkg/src/family-data.ts`.
- App Pages-project names from `projects/apps/**/wrangler.toml`.
...
| API CNAME files in `projects/apis/*/CNAME` | 19 |
...
All 19 live API CNAMEs point to `chirag127.github.io` and have a matching `projects/apis/<slug>/CNAME` file. This is the expected GH-Pages JSON-API rail.

| DNS hostname | DNS target | Matching CNAME file | Status |
|---|---|---|---|
| `aqi.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-aqi-cities-api/CNAME` | OK |
| `aqi-india.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-air-quality-india-api/CNAME` | OK |
| `budget.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-india-budget-numbers-api/CNAME` | OK |
| `currency.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-currency-rates-api/CNAME` | OK |
| `exams.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-india-exam-portal-status-api/CNAME` | OK |
| `fii-dii.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-flow-fii-dii-activity-api/CNAME` | OK |
| `fuel.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-india-petrol-diesel-api/CNAME` | OK |
| `gold-silver.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-gold-silver-rates-api/CNAME` | OK |
| `holidays.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-india-holidays-api/CNAME` | OK |
| `ifsc.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-ifsc-api/CNAME` | OK |
| `irctc.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-irctc-train-pnr-api/CNAME` | OK |
| `judgments.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-india-court-judgments-api/CNAME` | OK |
| `mf-nav.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-mf-nav-api/CNAME` | OK |
| `mmi.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-mmi-tickertape-mmi-api/CNAME` | OK |
| `pincode.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-pincode-api/CNAME` | OK |
| `rbi-rates.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-rbi-rates-api/CNAME` | OK |
| `rti.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-india-rti-api/CNAME` | OK |
| `so-trending.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-stackoverflow-trending-api/CNAME` | OK |
| `tickers.api.oriz.in` | `chirag127.github.io` | `projects/apis/oriz-nse-bse-tickers-api/CNAME` | OK |

**Note — `FAMILY_APIS` mismatch:** `family-data.ts` declares 14 APIs whose canonical hostnames do **not** match the 19 live API subdomains. The live rail follows the `projects/apis/*/CNAME` files (e.g. `fii-dii`, `mf-nav`, `rbi-rates`). `FAMILY_APIS` references aspirational names (`sip-emi`, `tax-india`, `gst`, `bmi`, `qr.api`, `shorten`, `convert.api`, `timezones`, plus the only two it gets right: `fii-dii.api.oriz.in` and `janaushdhi.api.oriz.in` — but `janaushdhi.api.oriz.in` is **not in DNS**). This is a registry-vs-reality drift; fix is out of scope for this audit.
...
- 73 total records read. Mapping logic matched (host, target) tuples against (a) `projects/apis/*/CNAME` literal content, (b) `FAMILY_APPS[].url` host, (c) `FAMILY_APIS[].url` host.
