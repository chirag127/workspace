...
description: "Apply CI templates to every submodule in one pass"
tags:
- runbook
- ci
- github-actions
...
- runbooks/workflow/bump-submodule-pointer
...
[`runbooks/workflow/bump-submodule-pointer.md`](./bump-submodule-pointer.md):
...
- [`../infrastructure/cloudflare-pages-for-all-sites.md`](../../infrastructure/cloudflare-pages-for-all-sites.md)
  — why CF Pages is primary.
- [`../infrastructure/github-pages-mirror-per-site.md`](../../infrastructure/github-pages-mirror-per-site.md)
