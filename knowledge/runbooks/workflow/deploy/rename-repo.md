...
description: Rename chirag127/oriz* repo to role-suffixed slug; update .gitmodules + submodules
tags:
- runbook
- git
- submodule
...
- [`branding/repo-naming-suffixes.md`](../../branding/repo-naming-suffixes.md) — what name to pick
