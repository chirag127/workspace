...
description: "Wire 3 lifestream pipelines to cron + webhooks"
tags:
- runbook
- lifestream
- github-webhooks
...
status: active
related:
- decisions/apps/lifestream-auto-event-sources
...
- services/monitoring/monitoring/healthchecks-io
...
[`lifestream-auto-event-sources`](../../decisions/apps/lifestream-auto-event-sources.md)
...
queue per the [hookdeck service](../../services/data/queue/hookdeck.md). The
...
[Hono umbrella API worker](../../decisions/compute/hono-worker-api-umbrella.md).
...
[CF Worker quota mitigation playbook](../../decisions/compute/cf-worker-quota-mitigation.md),
...
Per the
[`health-check-cron-plus-uptime`](../../decisions/compute/health-check-cron-plus-uptime.md)
decision:
...
- [Lifestream auto-event sources decision](../../decisions/apps/lifestream-auto-event-sources.md)
- [Lifestream JSONL canonical decision](../../decisions/database/lifestream-jsonl-canonical.md)
- [Hookdeck service](../../services/data/queue/hookdeck.md)
- [Wakatime service](../../services/business/productivity/wakatime.md)
- [healthchecks.io service](../../services/monitoring/monitoring/healthchecks-io.md)
- [Hono umbrella API worker decision](../../decisions/compute/hono-worker-api-umbrella.md)
