...
description: Add new Astro site in <10 min: clone starter, edit config, deploy to CF Pages
tags:
- runbook
- scaffold
- astro
...
status: active
related:
- decisions/apps/chrome-config-contract
...
- Brand name decided (4-7 letter short word; see [branding/repo-naming-suffixes](../../branding/repo-naming-suffixes.md) for the suffix matrix)
- Subdomain decided (e.g. `<brand>.oriz.in`)
- Site role decided (longform / catalog / hub / tool — see [sidebar-4-tier](../../decisions/frontend/sidebar-4-tier.md))
