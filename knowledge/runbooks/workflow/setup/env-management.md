...
description: "sops + age + GH Org Secrets env pipeline"
tags:
- runbook
- env
- secrets
...
- The decision driving this → [[security/env-single-source-auto-push]]
- Two-track delivery context → [[security/env-and-secrets-single-source]]
