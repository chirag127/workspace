...
description: "Step-by-step guide to set up Razorpay Subscriptions (India INR rail) and Paddle Checkout (rest-of-world USD rail) for the 4 oriz subscription tiers: Pro Monthly ₹99/$1.19, Pro Yearly ₹799/$9.59, Max Monthly ₹299/$3.59, Max Yearly ₹2499/$30. Both go through monthly+yearly only (no lifetime). Razorpay: Sole-proprietor PAN-only KYC. Paddle: Vendor signup with W-8BEN."
tags: [runbook, setup, razorpay, paddle, subscriptions, billing]
