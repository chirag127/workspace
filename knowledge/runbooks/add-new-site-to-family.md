...
description: "Add a new oriz-<name> repo as a submodule under sites/, register it in the family list, scaffold its design brief, set up its CI + Cloudflare Pages deploy, and bump the master pointer."
tags: [runbook, site, submodule, scaffold, family]
...
- Auth setup complete per [`auth-setup.md`](./auth-setup.md): `gh`,
