...
description: "Run when the OKF spec moves beyond v0.1. Read migration notes, update _okf.md format_version, find every concept file with the old version stamp, batch-update, and log the migration."
...
4. **Batch-update.** Two options depending on scope of the change:
    ...
    - **Schema migration** (renamed / added / removed fields): fan
        out subagents per
        [`../rules/parallel-by-default.md`](../rules/parallel-by-default.md).
