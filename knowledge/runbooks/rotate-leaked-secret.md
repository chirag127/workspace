...
description: "Run when a secret is suspected leaked, has entered any chat transcript, or has appeared in an untrusted log. Revoke at the dashboard, reissue, re-login locally, store via envpact, verify, then audit recent activity."
