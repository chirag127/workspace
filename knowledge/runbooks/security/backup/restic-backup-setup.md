...
description: 'Weekly encrypted restic backup to Backblaze B2 via GH Actions'
tags:
- runbook
- backup
- restic
...
[`decisions/architecture/backup-restic-to-b2.md`](../../decisions/ops/backup-restic-to-b2.md).
...
- All four values live in [Doppler](../../services/business/secrets/doppler.md);
...
- [`../services/data/storage/restic.md`](../../services/data/storage/restic.md) — service entry
- [`../services/data/storage/backblaze-b2.md`](../../services/data/storage/backblaze-b2.md) — backup target
- [`../services/business/cron/github-actions-schedule.md`](../../services/business/cron/github-actions-schedule.md) — substrate
- [`../decisions/architecture/backup-restic-to-b2.md`](../../decisions/ops/backup-restic-to-b2.md) — the lock
- [`../services/business/secrets/doppler.md`](../../services/business/secrets/doppler.md) — secret source-of-truth
