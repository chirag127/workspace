...
description: "Weekly backup of repo metadata (issues/PRs/wiki/releases) to Backblaze B2"
tags:
- runbook
- backup
- backblaze-b2
...
status: active
related:
- decisions/ops/backup-channels-alternative
