...
title: "Razorpay end-to-end setup \u2014 TEST keys + 4 plans + 4 promos + webhook\
  \ + E2E test + LIVE"
description: 'Step-by-step Razorpay subscriptions setup: test keys, webhook, promo codes, E2E test, LIVE'
tags:
- runbook
- billing
- razorpay
...
- 3-tier pricing decision → [`../monetisation/pricing/three-tier-free-pro-max.md`](../../monetisation/pricing/three-tier-free-pro-max.md)
- Billing webhook architecture → [`../decisions/architecture/billing-webhook-cf-pages-function.md`](../../decisions/compute/billing-webhook-cf-pages-function.md)
