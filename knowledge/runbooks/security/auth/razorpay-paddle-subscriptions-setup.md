...
description: "Set up Razorpay (INR) + Paddle (USD) subscription tiers"
tags:
- runbook
- setup
- razorpay
...
status: active
related:
- monetisation/pricing/three-tier-free-pro-max
- security/payment-architecture-direct-links
- decisions/compute/billing-webhook-cf-pages-function
