...
description: "One-time 9-host mirror setup"
tags:
- runbook
- mirror
- git-host
...
- Mirror decision → [`../../decisions/ops/mirror-to-9-popular-alternatives-2026-06-28.md`](../../decisions/ops/mirror-to-9-popular-alternatives-2026-06-28.md)
...
- Service files per host → [`../../services/infra/hosting/`](../../services/hosting)
