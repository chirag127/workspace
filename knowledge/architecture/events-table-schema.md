...
detail and indexes belong in the per-app `knowledge/` bundle inside the oriz-cs-me-app submodule (`projects/oriz-org/own/products/apps/personal/oriz-cs-me-app/knowledge/`) — this file
