...
description: The chirag127/oriz-me-data git repo is the authoritative store for lifestream events. JSONL append-only files are the source of truth; everything else is derived.
tags: [architecture, data, jsonl, git, canonical, lifestream]
...
- The same survival logic at the host layer → [layer-2-survival-fallback.md](layer-2-survival-fallback.md)
