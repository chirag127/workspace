...
description: Cloudflare Pages free is the primary host for all 11+ sites and the extensions catalog. Unlimited bandwidth, no card required, fails-closed at quota.
...
- The reason this choice is locked → [`../rules/no-card-on-file.md`](../rules/no-card-on-file.md)
- Where each site lives → [repo-layout.md](repo-layout.md)
