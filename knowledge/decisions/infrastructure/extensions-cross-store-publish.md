...
description: "Each extension repo includes an automated GitHub Actions publish workflow that submits the same artifact to Chrome Web Store, Firefox Add-ons, and Microsoft Edge Add-ons."
