...
description: "SSL + uptime monitoring is configured for the apex domain only. *.oriz.in subdomains inherit via Cloudflare auto-rotation."
tags: [monitoring, ssl, decision]
timestamp: 2026-06-20
format_version: okf-v0.1
status: active
related: [services/monitoring/better-stack, rules/never-hit-quotas]
---
