...
description: "Extensions authenticate users via Firebase Auth (chrome.identity.launchWebAuthFlow + auth.oriz.in); a license-key fallback exists for paranoid privacy users who refuse Firebase."
