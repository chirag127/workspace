...
title: "Code quality \u2014 5-tool stack (Sonarcloud + CodeRabbit + Codecov + Code\
  \ Climate + DeepSource)"
description: Five code-quality tools per public repo
...
- services/code/code-quality/dependabot
...
| 4 | [Code Climate Quality](../../../services/code/code-quality/codeclimate.md) | A — F maintainability grade per file | Dashboard + status check |
...
- **Apply via [`runbooks/workflow/apply-per-site-ci.md`](../../../runbooks/workflow/apply-per-site-ci.md)**
...
- [Code quality services index](../../../services/code/code-quality/index.md) — per-tool detail
...
- [Per-site CI runbook](../../../runbooks/workflow/apply-per-site-ci.md)
