...
description: Batch 13 lock covering distribution + reliability
...
- services/business/extension-store/firefox-add-ons
- services/business/extension-store/edge-add-ons
- services/business/extension-store/vs-code-marketplace
- services/business/extension-store/open-vsx-registry
- services/business/extension-store/index
- services/business/pwa/vite-pwa-astro
- services/business/pwa/index
- services/data/queue/cloudflare-queues
- services/data/queue/hookdeck
...
- decisions/compute/queue-cloudflare-native
...
[`@vite-pwa/astro`](../../../services/business/pwa/vite-pwa-astro.md). No native
...
- Every extension repo (`-ext` and `-vsc-ext` per
  [`branding/repo-naming-suffixes.md`](../../branding/repo-naming-suffixes.md))
...
- All credentials originate at [Doppler](../../../services/business/secrets/doppler.md)
  and mirror to [GitHub Secrets](../../../services/business/secrets/github-secrets.md)
  per [`security/secrets-management-doppler.md`](../../security/secrets-management-doppler.md).
- The earlier
  [`infrastructure/extensions-cross-store-publish.md`](../../infrastructure/extensions-cross-store-publish.md)
  (Batch 1) and
...
- [services/business/extension-store/index.md](../../../services/business/extension-store/index.md)
- [services/business/pwa/index.md](../../../services/business/pwa/index.md)
- [services/data/queue/index.md](../../../services/data/queue/index.md)
