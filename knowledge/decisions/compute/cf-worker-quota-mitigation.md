...
description: 8-step playbook for staying under CF Workers free tier
...
- services/business/social/satori-og-cards
...
[s.oriz.in short-link Worker](../../../services/business/short-link/cloudflare-worker.md),
the [Satori OG Worker route](../../../services/business/social/satori-og-cards.md),
...
KV reads are faster than [D1](../../../services/data/database/turso.md) /
[Neon](../../../services/data/database/neon-postgres.md) and use less CPU.
