...
description: Two API-mock tools. MSW handles in-browser + in-Node
...
status: active
related:
- services/code/testing/msw
- services/code/testing/mockoon
- services/code/testing/vitest
- services/code/testing/playwright
- decisions/ops/testing-three-layer
- decisions/compute/data-apis-open-meteo-alpha-vantage
...
1. **In-process mocks** — [MSW (Mock Service Worker)](../../../services/code/testing/msw.md).
   Service-Worker based in the browser; Node interceptor in tests.
   Used for [Vitest](../../../services/code/testing/vitest.md) unit / integration
   suites, [Storybook](../../../services/code/testing/storybook.md) stories
   ...
   upstream.
2. **Out-of-process mocks** — [Mockoon](../../../services/code/testing/mockoon.md).
   Free OSS desktop app + headless CLI. Used for E2E (
   [Playwright](../../../services/code/testing/playwright.md)) suites against
...
- **Reuses substrate already required by other family decisions.**
  MSW slots into the existing [Vitest setup](../../../services/code/testing/vitest.md)
  + [Storybook preview](../../../services/code/testing/storybook.md) the
  ...
  the same [GitHub Actions schedule](../../../services/business/cron/github-actions-schedule.md)
...
- **Cuts external-API load, which preserves quotas.** Pointing E2E
  ...
  [Alpha Vantage](../../../services/business/data-api/alpha-vantage.md) endpoint
...
- MSW handlers + Mockoon JSON files are version-controlled; PR
  changes get reviewed by [CodeRabbit](../../../services/code/code-quality/coderabbit.md)
...
- [MSW service entry](../../../services/code/testing/msw.md)
- [Mockoon service entry](../../../services/code/testing/mockoon.md)
- [Testing three-layer decision](../general/testing-three-layer.md)
- [Vitest service entry](../../../services/code/testing/vitest.md)
- [Playwright service entry](../../../services/code/testing/playwright.md)
