...
description: Two AI providers picked by surface. Puter.js for browser, CF Workers AI for server
...
|---|---|---|
| **Browser** (chat in `oriz-me`, on-page assistants, any client-side AI feature) | [Puter.js](../../../services/business/ai/puter-js.md) | User-pays free tier; we ship no API key, the family pays nothing per request |
| **Server** (inside the umbrella Hono Worker at `api.oriz.in`) | [Cloudflare Workers AI](../../../services/business/ai/cloudflare-workers-ai.md) | Native Worker binding, zero-egress within Cloudflare, 10K neurons / day free, no card |
...
- **Image generation** (occasional og:image fallback alongside
  [Satori](../../../services/business/social/satori-og-cards.md)) goes through
...
- [Puter.js service](../../../services/business/ai/puter-js.md)
