...
description: 'Compute split: GH Actions cron, CF Workers, specialized'
...
- The non-negotiable that drives this ? [`../rules/interaction/never-hit-quotas.md`](../../rules/interaction/never-hit-quotas.md)
- The Tier-2 quota-headroom playbook ? [`../decisions/architecture/cf-worker-quota-mitigation.md`](../../decisions/compute/cf-worker-quota-mitigation.md)
