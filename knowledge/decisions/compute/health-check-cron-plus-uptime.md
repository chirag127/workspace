...
title: "Health checks \u2014 split between healthchecks.io (cron heartbeats) and Better\
  \ Stack (HTTP uptime)"
description: Cron-job liveness verified by healthchecks.io
...
- services/monitoring/monitoring/better-stack
- services/monitoring/monitoring/instatus
- decisions/compute/cron-split-cf-vs-gh
- decisions/apps/lifestream-auto-event-sources
- infrastructure/monitor-apex-only
...
|---|---|---|---|
| **Cron-job liveness** (did this run?) | [healthchecks.io](../../../services/monitoring/monitoring/healthchecks-io.md) | Dead-man-switch heartbeat | 20 checks |
| **HTTP endpoint uptime** (is this URL serving?) | [Better Stack](../../../services/monitoring/monitoring/better-stack.md) | Active probe (3-min interval) | 10 monitors |
...
- [Better Stack service](../../../services/monitoring/monitoring/better-stack.md)
