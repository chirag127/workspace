...
description: Open-Meteo for weather, Alpha Vantage for finance
...
status: active
related:
- services/business/data-api/open-meteo
- services/business/data-api/alpha-vantage
- decisions/compute/cf-worker-quota-mitigation
- decisions/compute/hono-worker-api-umbrella
- decisions/ops/geocoding-deferred
...
- [Open-Meteo service entry](../../../services/business/data-api/open-meteo.md)
- [Alpha Vantage service entry](../../../services/business/data-api/alpha-vantage.md)
