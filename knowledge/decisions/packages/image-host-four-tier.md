...
description: '4-tier image host: CF Pages, imgbb, imgur, GH user content'
...
status: active
related:
- services/media/image-host/repo-hosted-cf-pages
- services/media/image-host/imgbb
- services/media/image-host/imgur
- services/media/image-host/github-user-content
- decisions/frontend/image-cdn-fallback-chain
- decisions/content/cms-markdown-in-repo-only
...
- **Storage caveat.** This decision governs **images only**.
  ...
  [Backblaze B2](../../../services/data/storage/backblaze-b2.md) per
