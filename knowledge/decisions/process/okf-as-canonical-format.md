...
description: OKF v0.1 for all concept files in knowledge bundles
...
- [Self-update rule](../../agent-rules/self-update-rule.md)
- [Knowledge bundle index](../../index.md)
- [Add-new-decision runbook](../../runbooks/workflow/add-new-decision.md) — the operational workflow that enforces this format
