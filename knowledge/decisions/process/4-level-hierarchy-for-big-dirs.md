...
- Cross-link references that used `services/firebase-spark.md` now resolve to `services/auth/firebase-spark.md`. All in-bundle links updated in the same edit; the [self-update rule](../../rules/agent/self-update-rule.md) carries the obligation.
