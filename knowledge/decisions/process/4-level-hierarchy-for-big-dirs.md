...
- Cross-link references that used `services/firebase-spark.md` now resolve to `services/business/auth/firebase-spark.md`. All in-bundle links updated in the same edit; the [self-update rule](../../agent-rules/self-update-rule.md) carries the obligation.
...
- [rules/self-update-rule](../../agent-rules/self-update-rule.md)
