...
description: Wakatime only time tracking
...
- **[Wakatime](../../../services/business/productivity/wakatime.md)** —
...
- **[Toggl Track](../../../services/business/productivity/toggl-track.md)** —
...
[Doppler](../../../services/business/secrets/doppler.md) per
...
- **No `TOGGL_API_TOKEN`** in [Doppler](../../../services/business/secrets/doppler.md)
...
- **The `services/business/productivity/toggl-track.md` file stays** with
...
- [Wakatime service entry](../../../services/business/productivity/wakatime.md) — sole time-tracking pick
- [Toggl Track service entry — REJECTED](../../../services/business/productivity/toggl-track.md) — audit trail
- [Productivity services index](../../../services/business/productivity/index.md)
