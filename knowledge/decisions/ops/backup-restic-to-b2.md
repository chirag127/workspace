...
description: Weekly encrypted restic backups to B2 via GH Actions
...
| Layer | Pick |
|---|---|
| Backup engine | [restic](../../../services/data/storage/restic.md) (OSS, BSD-2-Clause) |
| Backup target | [Backblaze B2](../../../services/data/storage/backblaze-b2.md) (free 10 GB + 3x egress) |
| Scheduler | [GitHub Actions schedule](../../../services/business/cron/github-actions-schedule.md) (weekly Sunday 03:00 UTC) |
...
- **Secrets** — `RESTIC_PASSWORD`, `B2_KEY_ID`, `B2_APPLICATION_KEY`,
  ...
  [Doppler](../../../services/business/secrets/doppler.md) and sync to GitHub
  Secrets per
...
- [restic service entry](../../../services/data/storage/restic.md)
- [Backblaze B2 service entry](../../../services/data/storage/backblaze-b2.md)
