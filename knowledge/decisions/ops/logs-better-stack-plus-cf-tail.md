...
description: 'Two-layer logs: CF Workers Tail + Better Stack'
...
status: active
related:
- services/monitoring/monitoring/cloudflare-workers-tail
...
- services/business/tooling/axiom
...
- **Same Better Stack account = no new vendor surface.** Better Stack
  ...
  [Instatus](../../../services/monitoring/monitoring/instatus.md) intentionally lives
...
[Sentry](../../../services/monitoring/monitoring/sentry.md). Default is `false` for
