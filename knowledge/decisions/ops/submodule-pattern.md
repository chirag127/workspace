...
title: "Submodule pattern \u2014 each site/package/extension is a separate GitHub\
  \ repo"
description: Each site/package/extension standalone GH repo
...
- The full directory layout → <!-- TODO: broken link, was [repo-layout.md](./repo-layout.md) -->
- What the master pointer represents → [master-pointer-as-production-sha.md](../general/master-pointer-as-production-sha.md)
- The branching rule → [`../rules/development/one-branch-only.md`](../../rules/development/one-branch-only.md)
