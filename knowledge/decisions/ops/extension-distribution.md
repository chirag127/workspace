...
description: Each extension own GH repo, submoduled under extensions/
...
- Where extensions sit in the repo layout → <!-- TODO: broken link, was [repo-layout.md](./repo-layout.md) -->
