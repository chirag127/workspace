...
description: Three-tier URL shortener, all free, no card
...
- services/business/short-link/tinyurl
- services/business/short-link/github-gist-redirect
- decisions/ops/url-shortener-quota-mitigation
...
|---|---|---|---|
| 1 (primary) | [s.oriz.in CF Worker](../../../services/business/short-link/cloudflare-worker.md) | Self-hosted, branded, edge-cached | Default for everything family-owned |
| 2 (fallback) | [TinyURL API](../../../services/business/short-link/tinyurl.md) | Free unlimited, no auth, no card | Outside oriz.in, or s.oriz.in down |
| 3 (zero-infra) | [GitHub Gist redirect](../../../services/business/short-link/github-gist-redirect.md) | Meta-refresh HTML page, immortal | Both above unavailable, or critical immutable redirect |
...
Documented at
[`services/business/short-link/tinyurl.md`](../../../services/business/short-link/tinyurl.md).
...
Documented at
[`services/business/short-link/github-gist-redirect.md`](../../../services/business/short-link/github-gist-redirect.md).
...
- [s.oriz.in Cloudflare Worker — Tier 1 service](../../../services/business/short-link/cloudflare-worker.md)
- [TinyURL — Tier 2 service](../../../services/business/short-link/tinyurl.md)
- [GitHub Gist redirect — Tier 3 service](../../../services/business/short-link/github-gist-redirect.md)
