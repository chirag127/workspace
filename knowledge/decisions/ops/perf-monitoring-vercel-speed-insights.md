...
description: Vercel Speed Insights for RUM Web Vitals
...
[Vercel Speed Insights](../../../services/monitoring/monitoring/perf/vercel-speed-insights.md)
...
- Per-site `ENABLE_SPEED_INSIGHTS=true|false` env var (mirrors the
  [Sentry pattern](../../../services/monitoring/monitoring/sentry.md#per-site-env-var-toggle-the-never-hit-quotas-pattern))
...
|---|---|---|
| Real-user Web Vitals (RUM) | [Speed Insights](../../../services/monitoring/monitoring/perf/vercel-speed-insights.md) | Free RUM with no Vercel hosting requirement |
| Server-side / edge | [Cloudflare Web Analytics](../../../services/monitoring/monitoring/analytics/cloudflare-web-analytics.md) | Already in use; free unlimited |
| API + Worker traces | [Sentry Performance](../../../services/monitoring/monitoring/sentry.md) | Already in use; same dashboard as errors |
| Lab perf in PR | [Lighthouse CI](../../../services/monitoring/a11y/lighthouse-ci.md) | Already in use; perf budget per PR |
