...
description: Voice/SMS deferred to Knock, no standalone provider
...
- decisions/ops/notifications-fcm-plus-knock
...
- **No current SMS-shaped feature.** None of the 11 sites or the
  ...
  [Passkeys](../../../services/business/auth/passkeys.md) and email-link sign-in
