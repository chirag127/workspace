...
description: 'Two-layer notifications: Knock + FCM'
...
- **No card** required at any layer. Spark + Resend + Knock all
  ...
  [Sentry](../../../services/monitoring/monitoring/sentry.md#per-site-env-var-toggle-the-never-hit-quotas-pattern))
...
- **Razorpay / Lemon Squeezy webhook** ? [Hookdeck](../../../services/business/tooling/hookdeck.md)
