...
description: Five analytics layers in parallel on every site
...
- decisions/ops/utm-attribution-strategy
...
|---|---|---|---|
| 1 | Edge / raw load | [Cloudflare Web Analytics](../../../services/monitoring/monitoring/analytics/cloudflare-web-analytics.md) | How many real visitors, from where, on what URL? (cookieless) |
...
- **CSP allow-list in [`_headers` preset](../../../services/business/security/cloudflare-headers.md)**
...
- [UTM tracking service](../../../services/monitoring/monitoring/analytics/utm-tracking.md)
