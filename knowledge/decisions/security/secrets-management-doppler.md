...
description: "Adopt Doppler as the single place every family secret is written, rotated, and audited. GitHub Secrets, Cloudflare Worker secrets, and Firebase config are downstream mirrors synced from Doppler."
...
[Doppler](../../services/secrets/doppler.md) is the **single source
of truth** for every secret used across the chirag127/oriz family.
Every other place a secret can live — [GitHub Secrets](../../services/secrets/github-secrets.md),
...
The user's home-grown [envpact](../../services/tooling/envpact.md)
