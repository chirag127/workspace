...
description: "Cloudflare Turnstile is the family's primary CAPTCHA; hCaptcha is the auto-detected regional fallback. Single <Captcha> component in oriz-kit performs the swap transparently."
...
related:
  ...
  - decisions/security/multi-provider-auth
---
...
2. If reachable → renders [Cloudflare Turnstile](../../services/security/cloudflare-turnstile.md) (the **primary**).
3. If blocked (corporate proxy / region / ad-blocker / Cloudflare-edge incident) → renders [hCaptcha](../../services/security/hcaptcha.md) (the **fallback**).
...
- Worker verify route accepts `{ token, provider: 'turnstile' | 'hcaptcha' }`
  ...
  secret key.
- Two new secrets in [Doppler](../../services/secrets/doppler.md):
...
The family's [`_headers` preset](../../services/security/cloudflare-headers.md)
must allow:
...
[App Check](../../services/auth/app-check-firebase.md) +
[reCAPTCHA Enterprise](../../services/auth/recaptcha-enterprise.md)
...
- [Cloudflare Turnstile service entry](../../services/security/cloudflare-turnstile.md)
- [hCaptcha service entry](../../services/security/hcaptcha.md)
- [security services index](../../services/security/index.md)
- [Cloudflare _headers — CSP coupling](../../services/security/cloudflare-headers.md)
- [App Check — Firestore bot defense, complementary layer](../../services/auth/app-check-firebase.md)
