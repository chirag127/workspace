...
description: "Locked 2026-06-20: three layers of bot defense, each at a different stage. (1) Cloudflare WAF + Bot Fight Mode at the edge blocks known-bad before it reaches a Worker. (2) Turnstile at the form-submit boundary gates contact + auth flows. (3) Hono rate-limit middleware in the api.oriz.in Worker throttles per-route per-IP. All three free, no card."
tags: [security, anti-bot, decisions, defense-in-depth, cloudflare, turnstile, hono]
timestamp: 2026-06-20
format_version: okf-v0.1
status: active
related:
  - services/security/cloudflare-waf
...
|---|---|---|---|
| 1 | Edge (zone-wide) | [Cloudflare WAF + Bot Fight Mode](../../services/security/cloudflare-waf.md) | Known-bad IPs, common attack patterns (SQLi/XSS/RFI), obvious bot signatures, DDoS |
| 2 | Form-submit boundary | [Cloudflare Turnstile](../../services/security/cloudflare-turnstile.md) (with [hCaptcha](../../services/security/hcaptcha.md) fallback) | Automated form submissions on contact / sign-up / comment forms |
| 3 | API per-route throttle | [Hono rate-limit middleware](../../services/security/hono-rate-limit.md) | Per-IP per-route abuse on the api.oriz.in Worker |
...
- **Every site** inherits all three layers automatically — they ride
  ...
  forms.
- **CSP allow-list** in
  [`_headers` preset](../../services/security/cloudflare-headers.md)
...
- **Observability** — the api.oriz.in Worker logs rate-limit
  trip events to [Axiom](../../services/tooling/axiom.md); Cloudflare
...
- [Cloudflare WAF service](../../services/security/cloudflare-waf.md)
- [Cloudflare Turnstile service](../../services/security/cloudflare-turnstile.md)
- [hCaptcha service — Turnstile fallback](../../services/security/hcaptcha.md)
- [Hono rate-limit service](../../services/security/hono-rate-limit.md)
