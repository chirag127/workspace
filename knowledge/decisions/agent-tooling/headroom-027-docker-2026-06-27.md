...
description: Hr 0.27 native build blocked by ASR. Docker bypasses. Backend anthropic passthrough
tags: [headroom, hai, docker, compression, sap, bedrock, asr]
timestamp: 2026-06-27
format_version: okf-v0.1
status: active
supersedes:
  - decisions/agent-tooling/hr-out-of-path-hai-direct-2026-06-27.md
  - decisions/agent-tooling/headroom-install-all-paths-2026-06-26.md
related:
