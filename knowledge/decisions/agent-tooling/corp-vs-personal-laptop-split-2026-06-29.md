...
The [`agent-fleet-parity`](../../../agent-rules/agent-fleet-parity.md) rule says "every agent sees same workspace rules, same MCP servers, same skills." That parity holds **per machine**:
