...
description: USerscript prototyping via Tweeks
  ...
  pointing at GitHub raw), commit to chirag127/userscripts monorepo, cross-publish
...
- DON'T let Tweeks be the source of truth. The .user.js in `chirag127/userscripts` is.
...
- monorepo location: [[infrastructure/projects-owner-own-forks-layout]]
