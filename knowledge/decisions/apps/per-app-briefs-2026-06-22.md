...
description: Source of truth for what each of 26 apps does + sections
...
status: active
related:
- decisions/apps/ncert-combined-pdf-directory
- decisions/apps/ncert-dual-mode-download
- decisions/apps/janaushdhi-app-scope
- decisions/content/blog-cross-post-strategy
- decisions/apps/home-app-shape
- decisions/apps/content-apps-scope
- decisions/apps/cs-me-app-scope
