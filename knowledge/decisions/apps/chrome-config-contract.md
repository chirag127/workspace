...
description: 4 per-site config files drive generic components, 3-level contract
...
- decisions/frontend/sidebar-4-tier
- design/datasheet-dark
- decisions/stack/a11y-three-tools
- decisions/frontend/multi-engine-search-button
...
columns). See [`design/datasheet-dark.md`](../../design/datasheet-dark.md).
