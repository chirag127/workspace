...
description: Every app follows contents spec. 4-config structure
...
- [scaffold-a-new-site](../../../runbooks/workflow/scaffold-a-new-site.md) — runbook (predates v6.2; needs refresh)
