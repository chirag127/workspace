...
description: "Bloomberg-terminal-for-Indian-credit-cards: cool slate surface, carbon-blue primary, vermilion only on negative numbers, wide-mono display type, CSS-rendered embossed card signature."
