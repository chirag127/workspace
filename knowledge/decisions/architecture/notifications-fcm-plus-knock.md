...
description: "Two-layer notification stack: Knock owns multi-channel orchestration (in-app + email + SMS + web push); FCM stays as the web-push transport. Free 10K notifs/mo on Knock, free unlimited on FCM."
