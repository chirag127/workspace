---
type: decision
title: "Image CDN — chained 3-tier fallback (Cloudflare Images → wsrv.nl → ImageKit)"
description: "Every image rendered through the @chirag127/oriz-kit <Image> wrapper resolves through a 3-tier fallback: Cloudflare Images first, wsrv.nl on 5xx, ImageKit on 5xx."
tags: [images, cdn, fallback, oriz-kit, never-hit-quotas]
...
- All image upload flows still target a single canonical home — see
  [`object-storage-split.md`](./object-storage-split.md). The CDN
