---
type: decision
title: "oriz-status-app — self-hosted status page replaces UptimeRobot + Better Stack"
...
tags: [status, monitoring, uptime, cloudflare, workers, kv, telegram, rss, decisions, architecture]
timestamp: 2026-06-22
format_version: okf-v0.1
status: active
related:
  - decisions/architecture/health-check-cron-plus-uptime
  - decisions/architecture/status-banner-on-every-site
...
[status-banner-on-every-site](./status-banner-on-every-site.md))
