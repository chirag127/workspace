...
description: "No standalone voice or SMS provider in 2026-06-20. Twilio + Vonage rejected on card-on-file grounds. If/when SMS becomes needed, the family routes it through Knock's bundled SMS channel — already locked as the multi-channel notification orchestrator (10K notifs/mo free)."
