...
description: "Every PR runs axe-core, Pa11y, and Lighthouse CI in parallel. PR fails on any new a11y violation in any tool. Each tool catches a different category."
