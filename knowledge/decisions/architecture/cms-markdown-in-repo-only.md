...
description: "Every site stores content as .md / .mdx files in its own repo. Decap CMS, TinaCMS, Strapi, Sanity, Contentful, Storyblok and every other headless CMS are explicitly REJECTED."
tags: [cms, content, markdown, mdx, no-vendor-lock-in, monorepo]
...
- **The `oriz-me` lifestream is the ONLY exception.** It uses
  ...
  [`lifestream-jsonl-canonical.md`](./lifestream-jsonl-canonical.md).
...
- **Feed generation reads the markdown directly** — see
  [`feeds-rss-atom-json.md`](./feeds-rss-atom-json.md) for how
...
- [3-format feeds](./feeds-rss-atom-json.md) — RSS / Atom / JSON Feed generated from markdown at build time
