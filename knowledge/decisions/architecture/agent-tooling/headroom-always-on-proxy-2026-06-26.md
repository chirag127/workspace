...
description: "Headroom runs as a persistent background proxy, not a per-invocation spawn. Trade-off: idle RAM for zero cold-start latency on every agent/userscript call. Starts at login via Task Scheduler."
