...
description: "Claude Code + Bedrock chain stays corp-laptop-only forever; personal laptop runs OpenCode/Kilo/Antigravity on free providers (OpenRouter + Z.ai + Google AI Studio). No card-on-file rule makes CC paid tier impossible on personal."
