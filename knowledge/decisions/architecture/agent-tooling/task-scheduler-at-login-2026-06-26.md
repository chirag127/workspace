...
description: "Headroom always-on proxy launches at user logon via a Task Scheduler entry — not as a Windows Service, not via startup folder. Runs as the logged-in user with their env vars + creds intact."
