...
description: Cline dropped 2026-06-29 after grilling. Fleet shrinks from 5 → 4 agents. Failover order if Claude Code is unavailable is OpenCode → Kilo Code → Antigravity. Aider rejected (no native MCP). Other 55 agents in the wider registry are lazy-install only.
...
related:
  ...
  - decisions/architecture/agent-tooling/nothing-global-rule-2026-06-29
---
