...
description: "Locked 2026-06-20: family-wide project / task management lives on a single GitHub Projects board on chirag127/oriz master, with kanban + table + roadmap views. Notion, Obsidian Tasks, Linear, ClickUp, Asana, Trello — all REJECTED. The knowledge/ OKF bundle covers documentation; GitHub Projects covers tasks."
...
- **Free, GitHub-native, no card.** Projects v2 is part of every
  ...
  no card on file ([`rules/no-card-on-file`](../../rules/no-card-on-file.md) +
