...
[5-tool code-quality decision](./code-quality-five-tools.md) — the 5
...
- **`templates/per-site-ci/.github/workflows/ci.yml`** runs Tokei in
  ...
  [`family-wide-stats-page`](./family-wide-stats-page.md).
...
- **Build-time aggregation** — the family `/stats` page on
  `oriz.in` (per
  [`family-wide-stats-page`](./family-wide-stats-page.md)) rolls up
...
- [5-tool code-quality decision (extended here)](./code-quality-five-tools.md)
- [Family-wide /stats page decision](./family-wide-stats-page.md)
