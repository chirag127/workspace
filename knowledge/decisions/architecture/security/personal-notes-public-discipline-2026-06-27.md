...
description: "Personal Obsidian vault lives inside the public oriz repo. No private fork, no .gitignore wall. Confidentiality is enforced by author discipline (don't write secrets), not by tooling."
