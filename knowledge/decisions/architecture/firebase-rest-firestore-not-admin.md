...
description: "The umbrella Hono Worker uses firebase-rest-firestore (REST + service-account JWT). The firebase-admin SDK is excluded because workerd only partially supports gRPC."
tags: [firebase, cloudflare, workers, dependency, firestore]
