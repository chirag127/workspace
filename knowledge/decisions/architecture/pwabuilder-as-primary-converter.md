...
- `@chirag127/astro-distribute` becomes a thin CLI wrapping PWABuilder CLI + (optional) Tauri. Both routes share the same `dist/` PWA build. See [the-18-packages.md](../../architecture/the-18-packages.md).
...
- The 17 Packages (umbrella) → [../../architecture/the-18-packages.md](../../architecture/the-18-packages.md)
