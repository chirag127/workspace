...
- **Lifestream summary** — counts derived from the
  [oriz-me JSONL](./lifestream-jsonl-canonical.md) by `kind` (git
...
- [Code stats everything decision](./code-stats-everything.md)
- [Lifestream auto-event sources](./lifestream-auto-event-sources.md)
- [Cron split decision](./cron-split-cf-vs-gh.md)
- [CF Worker quota mitigation playbook](./cf-worker-quota-mitigation.md)
- [Markdown-in-repo only decision](./cms-markdown-in-repo-only.md)
