...
description: "2026-06-28 decision to abandon Cloudflare Pages (100-project cap, OAuth DNS scope friction) and host all static API sites on GitHub Pages. Cloudflare DNS retained. GA4 + Clarity + PostHog + Sentry + CF Web Analytics on every page via shared org-level secrets and the @oriz/api-fleet-template Astro Integration."
...
supersedes:
  ...
  - decisions/architecture/fleet/multi-git-mirror-and-auto-start-2026-06-28
related:
