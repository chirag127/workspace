...
description: "Locked 2026-06-29. Single .mcp.json synced to all agents via scripts/sync-mcp-configs.mjs. 6 core MCP servers kept; 12 toolbox servers pruned later. All 5 agents retained."
