...
description: "Every site ships a sidebar via @chirag127/sidebar, but the sidebar config differs by site type. Four tiers: A) auto-generated for tools, B) curated TOC for longform, C) browse + search for catalogs, D) family directory for the brand hub."
tags: [architecture, sidebar, ui, design]
