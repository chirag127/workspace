...
description: Both kept as fork submodules. Run side-by-side for eval. No hosting, local SQLite. Pull from upstream regularly. File feature-gap issues upstream. No new aggregator project.
