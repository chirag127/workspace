...
description: "Drop the Go CLI fork; standalone notifications no longer fit the 4-agent fleet model."
tags: [fleet, fork, deletion, claude-code]
timestamp: 2026-06-29
format_version: okf-v0.1
status: active
supersedes:
  - decisions/architecture/fleet/scope-cut-2026-06-25.md
related:
  - decisions/architecture/fleet/scope-cut-2026-06-25.md
  - rules/agent/preferences/scope-cut-only-shipping-survives.md
