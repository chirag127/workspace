...
description: "Locked 2026-06-20: Open-Meteo for weather data, Alpha Vantage for finance / market data. Both free, no card. Both fronted by the umbrella Hono Worker with KV-backed cache (1h TTL on weather, 1d TTL on finance EOD) per the CF Worker quota mitigation playbook."
...
related:
  ...
  - decisions/architecture/geocoding-deferred
...
[Geocoding stays deferred](./geocoding-deferred.md) — separate
