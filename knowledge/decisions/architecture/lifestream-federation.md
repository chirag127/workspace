...
description: "oriz-me lifestream JSONL stays canonical; mirrored as AT Protocol records under me.oriz.in.atproto AND ActivityPub outbox at me.oriz.in/activitypub/outbox. Single source, two protocols."
...
The canonical
[lifestream JSONL in `chirag127/oriz-me-data`](./lifestream-jsonl-canonical.md)
...
- **Single canonical source preserves the
  ...
  [JSONL canonical decision](./lifestream-jsonl-canonical.md). If
