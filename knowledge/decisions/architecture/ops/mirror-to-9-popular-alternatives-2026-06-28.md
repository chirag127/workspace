...
description: "Backup repos/own/* submodules to 9 free, no-self-hosting GitHub alternatives — GitLab, Codeberg, Bitbucket, GitFlic, Azure DevOps, NotABug, GitGud, RocketGit, and Radicle (P2P) — driven entirely from GitHub Actions on the oriz-org/workspace umbrella repo. No local state, no self-hosted hardware, no card-on-file."
