...
description: "Three-layer build cache strategy. Layer 1: pnpm content-addressable global store dedupes deps cross-repo locally. Layer 2: GitHub Actions cache (10 GB/repo free) keyed by pnpm-lock.yaml hash + Astro build cache keyed by source hash. Layer 3: Turbo Remote Cache + Bazel REJECTED — Vercel signup + card / overengineering."
