...
description: "Razorpay-hosted donation button (button ID pl_T4iEPIDcALKLPk) mounted on every app's /sponsors route + oriz-cs-me-app footer. One-click: opens Razorpay-hosted donation page; user picks amount; payment received. Separate from subscription flow (donations are one-time, not recurring). Integrated as shared <SponsorButton /> in @chirag127/astro-billing."
tags: [decision, razorpay, donation, sponsor, billing, button]
...
related:
  ...
  - runbooks/razorpay-end-to-end-setup
---
