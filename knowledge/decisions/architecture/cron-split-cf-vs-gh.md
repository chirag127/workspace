---
type: decision
title: "Cron split — Cloudflare Cron Triggers + GitHub Actions schedule, by job shape"
description: "Run cron on BOTH substrates. CF Cron Triggers for in-Worker low-latency jobs; GH Actions schedule for build / publish jobs that need a runner. Pick by the job's shape, not by convenience."
