...
description: "Every content-bearing site publishes three feed formats: /rss.xml (RSS 2.0, source-of-truth for oriz-omnipost), /atom.xml (Atom 1.0), /feed.json (JSON Feed v1.1). oriz-kit ships <FeedDiscovery /> + generators."
...
in [`cross-post-engine.md`](./cross-post-engine.md)); Atom + JSON
