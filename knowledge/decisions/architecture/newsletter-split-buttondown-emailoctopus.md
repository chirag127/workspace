...
description: "Two newsletter senders side by side. Buttondown handles the technical / dev audience (Markdown + API). EmailOctopus handles general marketing (visual editor, larger free tier)."
