...
description: "Type-safe site→API client built via Hono's hc<AppType>. No codegen, no schema files — backend types flow to N frontends through a workspace package."
