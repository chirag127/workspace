...
description: PWABuilder primary PWA converter for Astro apps
...
status: active
related:
- decisions/compute/distribution-and-queues-locked
- architecture/packages/the-23-packages
- runbooks/workflow/build-distributable
...
- The runbook [build-distributable.md](../../../runbooks/workflow/build-distributable.md) is updated to reflect PWABuilder primary + Tauri optional.
...
- The build runbook ? [../../runbooks/workflow/build-distributable.md](../../../runbooks/workflow/build-distributable.md)
