...
description: Refines maximalist-footer decision. Each app gets own footer
...
supersedes_in_part: decisions/architecture/legal-pages-package-in-domain (per-app
  customization)
related:
- decisions/frontend/maximalist-footer-and-monetization-everywhere
- decisions/packages/legal-pages-package-in-domain
