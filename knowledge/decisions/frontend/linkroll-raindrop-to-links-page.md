...
title: "Linkroll \u2014 Raindrop.io is source of truth, blog.oriz.in/links built at\
  \ deploy time"
description: Family linkroll lives in public Raindrop.io collection
...
status: active
related:
- services/business/social/raindrop-io
...
[Raindrop.io](../../../services/business/social/raindrop-io.md).
...
[Cloudflare Pages](../../../services/infra/hosting/cloudflare-pages.md), with
...
A nightly [GitHub Actions schedule](../../../services/business/cron/github-actions-schedule.md)
...
- **Free, no card.** Per
  [`services/business/social/raindrop-io.md`](../../../services/business/social/raindrop-io.md).

## Implications

- `oriz-blog-site` reads `RAINDROP_TOKEN` from
  [Doppler](../../../services/business/secrets/doppler.md). The token authorises
...
- For each item, the build looks up an existing
  [`s.oriz.in/<slug>`](../../../services/business/short-link/cloudflare-worker.md)
...
- [Raindrop.io service entry](../../../services/business/social/raindrop-io.md)
- [s.oriz.in shortener](../../../services/business/short-link/cloudflare-worker.md)
