...
description: Dismissible <StatusBanner /> from oriz-kit on every site
...
[Better Stack](../../../services/monitoring/monitoring/better-stack.md)'s public
...
- **Better Stack is already the source of truth.** The same monitor
  graph that powers the [primary status page](../../../services/monitoring/monitoring/better-stack.md)
...
- **Vendor-redundant comms.** When combined with the
  ...
  [healthchecks.io heartbeat](../../../services/monitoring/monitoring/healthchecks-io.md),
...
([Instatus](../../../services/monitoring/monitoring/instatus.md)) automatically.
...
- **Dismissal cookie** uses the per-site cookie pattern; falls under
  ...
  [`Klaro`](../../../services/business/security/klaro.md) consent (no banner
...
- [Better Stack (primary status page + incidents RSS)](../../../services/monitoring/monitoring/better-stack.md)
