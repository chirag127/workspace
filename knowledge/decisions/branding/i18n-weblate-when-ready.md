...
description: "The family stays English-only until a site or extension shows real non-English demand. When that day comes, Weblate Hosted Libre is the chosen translation-management platform."
tags: [decisions, branding, i18n, weblate, deferred-then-locked]
timestamp: 2026-06-20
format_version: okf-v0.1
status: active
related:
  - services/i18n/weblate-hosted-libre
  - services/i18n/tolgee
...
[Weblate Hosted Libre](../../services/i18n/weblate-hosted-libre.md)
as the chosen tool.

This **revisits and refines** the earlier deferral at
[`services/i18n/tolgee.md`](../../services/i18n/tolgee.md): the
...
- **Tolgee stays `rejected`** in the service catalog. The
  `services/i18n/tolgee.md` page cross-links to weblate as the
  picked replacement.
