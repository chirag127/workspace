...
`sites/oriz-me/`. It hosts at `me.oriz.in` and serves as Chirag's
...
- The site has its own v2 design brief at `knowledge/design/oriz-me.md` and its own `knowledge/decisions/` directory under `sites/oriz-me/knowledge/`.
