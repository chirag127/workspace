...
description: "The family's RSS-driven cross-poster is named @chirag127/oriz-omnipost — palette: omni- prefix + post; user said 'name omnipotent'. One button to broadcast every blog post to every supported platform."
