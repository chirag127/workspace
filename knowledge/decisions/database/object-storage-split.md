...
description: Versioned binaries in GitHub Releases. Unversioned blobs elsewhere
...
status: active
related:
- services/data/storage/github-releases
- services/data/storage/backblaze-b2
- services/data/storage/cloudflare-r2
...
| Use case | Home |
|---|---|
| Versioned binaries (`(repo, tag, asset-name)` identity) | [GitHub Releases](../../../services/data/storage/github-releases.md) |
| Unversioned blobs (backups, raw originals, archives) | [Backblaze B2](../../../services/data/storage/backblaze-b2.md) |

[Cloudflare R2](../../../services/data/storage/cloudflare-r2.md) is
...
- [GitHub Releases](../../../services/data/storage/github-releases.md)
- [Backblaze B2](../../../services/data/storage/backblaze-b2.md)
- [Cloudflare R2 (rejected)](../../../services/data/storage/cloudflare-r2.md)
