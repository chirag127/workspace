...
description: Every DB administered through vendor browser console only
...
- services/data/database/neon-postgres
- decisions/database/db-add-neon-postgres
- decisions/database/firebase-rest-firestore-not-admin
