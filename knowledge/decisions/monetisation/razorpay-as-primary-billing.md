...
description: "Razorpay is the primary billing/checkout provider; Stripe, Lemon Squeezy, and Paddle are documented fallbacks if Razorpay rejects the merchant or dies."
...
- [Razorpay service entry](../../services/payment/razorpay.md)
