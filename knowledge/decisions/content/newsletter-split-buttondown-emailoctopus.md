...
description: Two newsletter senders. Buttondown technical, EmailOctopus marketing
...
status: active
related:
- services/business/email/buttondown
...
|---|---|---|---|
| [Buttondown](../../../services/business/email/buttondown.md) | Technical / developer | 100 subs | Markdown native, REST API, RSS-to-email |
