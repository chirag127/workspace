...
description: oriz-me JSONL canonical, AT Protocol mirror
...
status: active
related:
- services/business/social/atproto-firehose
- services/business/social/activitypub
...
2. **ActivityPub** — `Note` objects published to the outbox at
   ...
   See [`services/business/social/activitypub.md`](../../../services/business/social/activitypub.md).
...
- ActivityPub actor key pair: RSA / Ed25519 stored in
  [Doppler](../../../services/business/secrets/doppler.md); public key embedded
...
- [AT Protocol mirror service entry](../../../services/business/social/atproto-firehose.md)
- [ActivityPub mirror service entry](../../../services/business/social/activitypub.md)
- [social services index](../../../services/business/social/index.md)
