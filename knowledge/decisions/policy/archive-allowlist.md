...
deletion](../../rules/interaction/never-delete-empty-placeholder-repos.md) applies
...
- <!-- TODO: broken link, was [`../decisions/branding/oriz-urls-to-md-site-empty-placeholder.md`](../decisions/branding/oriz-urls-to-md-site-empty-placeholder.md) --> — canonical "empty but reserved" example
...
- [`../decisions/branding/repo-naming-suffixes.md`](../branding/repo-naming-suffixes.md) — slug taxonomy this allowlist is built around
