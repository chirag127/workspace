...
- **No card-on-file.** Per [no-card-on-file rule](../../rules/interaction/no-card-on-file.md),
...
- [`../decisions/monetisation/no-subscriptions-anywhere.md`](../monetisation/no-subscriptions-anywhere.md) — the decision-version of this policy
