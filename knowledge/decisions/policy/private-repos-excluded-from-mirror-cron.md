---
type: decision
title: "Private repos are excluded from the 7-host mirror cron"
...
The 7-host mirror cron in `.github/workflows/mirror-all.yml` MUST NOT push private repos to public mirror hosts. Two filters in series:
...
- The mirror decision: [[decisions/architecture/ops/mirror-to-7-popular-alternatives-2026-06-28]]
