...
| 2026-06-29 | Knowledge restructure | Full recategorisation: rules/agent/ → agent-rules/ (L1), decisions/architecture/ flattened → decisions/, decisions/{branding,design,infrastructure,monetisation,policy,security} → L1, services/ → 6 groups (infra/data/code/business/monitoring/media), runbooks/ deepened (platform/workflow split), concepts/ → core-concepts/, inbox/ → personal/inbox/, playbooks/ merged into runbooks/, archive/ deleted, decisions/pricing/ → monetisation/pricing/, decisions/process/ merged (7→7), 38 general/ files distributed to categories |
