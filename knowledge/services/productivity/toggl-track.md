...
description: "REJECTED 2026-06-20 — manual time tracker. Walked back the same day it was adopted: violates the new auto-only-tracking rule. Wakatime stays as the sole time-tracking pick (auto via IDE plugin); non-coding time is intentionally NOT tracked rather than manually tracked. File kept for audit trail."
