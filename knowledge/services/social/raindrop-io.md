...
type: service
title: "Raindrop.io"
description: "Bookmarking SaaS used as the source of truth for the family's linkroll. Free unlimited bookmarks + collections + REST API. Powers blog.oriz.in/links built at deploy time."
