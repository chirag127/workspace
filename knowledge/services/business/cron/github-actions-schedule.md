...
description: "Build- and publish-shaped scheduled jobs on GitHub Actions — free for public repos"
...
- **Unlimited minutes** on public repos (every family repo is public — see [one-branch-only rule](../../decisions/process/one-branch-only-rule.md) and [cloudflare-pages-for-all-sites.md](../../infrastructure/cloudflare-pages-for-all-sites.md)).
