...
description: "Self-built family privacy page at oriz.in/privacy — canonical URL all sites reference"
...
swap_cost: low
related:
  - branding/family-wide-privacy-page
...
- **Termly / iubenda / Privacy Policies Generator** — paid past free
  ...
  content, fights [`no-subscriptions-anywhere`](../../monetisation/no-subscriptions-anywhere.md).
...
`repos/oriz/own/prod/apps/personal/oriz-cs-me-app/src/content/legal/privacy.md` (master site). If
...
locked at
[`branding/family-wide-privacy-page.md`](../../branding/family-wide-privacy-page.md).
