...
|---|---|
| Capacitor | Native wrapping; Apple Developer Program $99/yr conflicts with [`monetisation/no-subscriptions-anywhere.md`](../../monetisation/no-subscriptions-anywhere.md). Re-open only when a hardware/iOS-background-sync need lands. |
