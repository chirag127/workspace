...
[security/security-headers-strategy.md](../../security/security-headers-strategy.md).
The captcha pair is locked in
[security/captcha-turnstile-plus-hcaptcha.md](../../security/captcha-turnstile-plus-hcaptcha.md).
...
Locked at
[`security/anti-bot-defense-in-depth.md`](../../security/anti-bot-defense-in-depth.md).
...
- [Captcha decision — Turnstile primary + hCaptcha fallback](../../security/captcha-turnstile-plus-hcaptcha.md)
