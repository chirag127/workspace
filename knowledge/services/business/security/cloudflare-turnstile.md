...
description: "Privacy-friendly CAPTCHA — free unlimited, CF-native, primary captcha"
...
the [`<Captcha>` component in `@chirag127/oriz-kit`](../../security/captcha-turnstile-plus-hcaptcha.md)
...
- [hCaptcha](./hcaptcha.md) — regional fallback (we run **both**, see
  the [decision](../../security/captcha-turnstile-plus-hcaptcha.md)).
