...
description: "Eclipse Foundation's vendor-neutral VS Code extension registry — free OSS, no card"
...
- [Repo naming suffixes (`-vsc-ext`)](../../branding/repo-naming-suffixes.md)
