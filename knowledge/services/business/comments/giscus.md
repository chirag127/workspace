...
type: service
title: "Giscus"
description: "GitHub-Discussions-backed comments — free forever, no card"
...
related:
  ...
  - services/business/comments/index
...
- [`chirag127/blog-site`](../../branding/repo-naming-suffixes.md)
  — blog post discussions, mapped by `pathname`
- [`chirag127/lore`](../../branding/repo-naming-suffixes.md)
  — per-book review discussions, mapped by `title`

NOT on app sites — utility apps don't carry a comments surface (see
[`services/business/comments/index.md`](./index.md) for the rationale).
...
- Click-to-load fits the family's
  [consent posture](../../security/consent-management-multi-category.md)
