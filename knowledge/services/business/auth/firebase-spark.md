...
description: "Auth + Firestore on free Spark plan — never upgraded to Blaze"
...
- [Never enable Blaze](../../infrastructure/firebase-spark-forever.md)
- [Layer 3 — Firebase Spark](../../security/layer-3-auth-firebase-spark.md)
