...
description: "Static security-headers config served directly from Cloudflare Pages via the `_headers` file. Free unlimited, ships in @chirag127/oriz-kit as a preset."
...
[security-headers-strategy](../../decisions/security/security-headers-strategy.md).
