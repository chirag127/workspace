...
type: service
title: "Klaro"
description: "OSS consent manager. Lazy-loaded ONLY for EU/UK visitors when a site loads a cookie-issuing tracker (GA4 / PostHog). Hosted from jsDelivr; free, no card."
...
provider: kiprotect
free_tier: "OSS (BSD-3-Clause). Zero licence cost. Delivered from jsDelivr (free CDN per services/cdn/jsdelivr.md)."
swap_cost: low
related:
  - services/analytics/cloudflare-web-analytics
  - services/analytics/posthog
  - services/cdn/jsdelivr
...
[`decisions/security/cookie-banner-policy.md`](../../decisions/security/cookie-banner-policy.md) —
