...
description: "Web-based translation management platform — free for libre / open-source projects. Picked as the family's i18n tool for if/when sites or extensions add non-English audiences."
...
related:
  ...
  - decisions/branding/i18n-weblate-when-ready
...
Per [`decisions/branding/i18n-weblate-when-ready.md`](../../decisions/branding/i18n-weblate-when-ready.md):
