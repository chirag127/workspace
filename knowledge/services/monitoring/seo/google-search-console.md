...
description: "Google sitemap submission + index monitoring + manual-action notices"
...
- Domain-property verification via Cloudflare DNS TXT record (one
  ...
  [`infrastructure/spaceship-registrar-cloudflare-dns.md`](../../infrastructure/spaceship-registrar-cloudflare-dns.md))
