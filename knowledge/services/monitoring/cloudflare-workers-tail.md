...
description: "Live tail of Worker console output via wrangler tail. Free, included with Cloudflare Workers. Sub-100ms request → terminal. ~5 min retention (WebSocket session) — for active debugging only."
