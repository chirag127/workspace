...
type: service
title: "Instatus"
description: "Redundant status page — 5 components, 25K subscribers, no card"
...
- [infrastructure/monitor-apex-only](../../infrastructure/monitor-apex-only.md) — same apex-only scope applies to both status pages
