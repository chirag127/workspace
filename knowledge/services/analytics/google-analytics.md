...
description: "Marketing-funnel analytics — acquisition / engagement / conversion against advertiser-standard definitions. Free, no card."
...
[`decisions/security/consent-management-multi-category.md`](../../decisions/security/consent-management-multi-category.md):
...
Per the [consent decision](../../decisions/security/consent-management-multi-category.md),
...
answers, per
[`services/security/klaro.md`](../security/klaro.md). Hits made
