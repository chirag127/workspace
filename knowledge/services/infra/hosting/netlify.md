...
related:
  ...
  - services/infra/hosting/github-pages
  - services/infra/hosting/vercel
...
- [Vercel](./vercel.md)
- [Cloudflare Pages for all sites decision](../../infrastructure/cloudflare-pages-for-all-sites.md) — why Netlify stays fallback-only
