...
type: service
title: "OpenRouter"
description: "LLM API gateway — DeepSeek / Llama / Moonshot free models. Rejected 2026-06-20: we use Puter.js exclusively; OpenRouter is mentioned only because Puter.js mirrors its model IDs."
