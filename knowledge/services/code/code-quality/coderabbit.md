...
type: service
title: "CodeRabbit"
description: "AI code review per PR — free forever for OSS/public repos"
...
- [services/code/code-quality/dependabot](./dependabot.md)
- [services/code/code-quality/sonarcloud](./sonarcloud.md)
- [rules/match-surrounding-style](../../rules/interaction/match-surrounding-style.md)
- [runbooks/clean-install](../../runbooks/workflow/clean-install.md)
