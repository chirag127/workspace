...
description: "Web push transport — browser/PWA push notifications across the family. Free unlimited on Spark, no card. Knock layered on top for multi-channel orchestration."
...
- HTTP v1 API for server-side send (works from a Cloudflare Worker
  ...
  [`services/auth/firebase-spark.md`](../auth/firebase-spark.md))
- iOS PWA support landed in iOS 16.4 — covered for free.

## Card / subscription required?

**NO.** Spark tier — the family's
[firebase-spark-forever decision](../../decisions/infrastructure/firebase-spark-forever.md)
