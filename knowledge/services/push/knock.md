...
type: service
title: "Knock"
description: "Multi-channel notification orchestration — in-app + email + SMS + web push from one workflow. Free 10K notifs/month, no card. Layered on top of FCM for delivery."
