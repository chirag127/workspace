...
description: "Schema.org JSON-LD markup emitted via a `<JsonLd>` component in @chirag127/oriz-kit. Article + BreadcrumbList + Organization + WebSite + Person types across the family."
