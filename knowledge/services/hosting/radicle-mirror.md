...
description: "Radicle is mirror host #7. Free peer-to-peer git network; push via `rad` CLI to public seed node `radicle.garden` — no self-hosted Radicle node required. Used as one of 9 popular GitHub alternatives in the umbrella's weekly mirror cron."
