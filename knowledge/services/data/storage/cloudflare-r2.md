...
type: service
title: "Cloudflare R2"
description: "REJECTED — card-on-file on Workers Paid plan, replaced by B2 + GH Releases"
...
related:
  ...
  - services/infra/compute/cloudflare-r2
...
A prior entry at [services/infra/compute/cloudflare-r2.md](../compute/cloudflare-r2.md)
...
- [services/infra/compute/cloudflare-r2](../compute/cloudflare-r2.md) — stale active entry, to be flipped
