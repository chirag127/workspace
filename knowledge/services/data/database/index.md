...
- [architecture/canonical-store-jsonl](../../decisions/database/canonical-store-jsonl.md)
- [architecture/cloud-dbs-as-caches](../../decisions/database/cloud-dbs-as-caches.md)
