...
type: service
title: "Neon Postgres"
description: "Serverless Postgres — free tier, no card, scale-to-zero, branching for previews"
...
- Up to 60K Neon Auth MAU (Neon-bundled auth, not used here — we
  stay on Firebase Auth, see [`services/business/auth/firebase-auth.md`](../auth/firebase-auth.md))
