...
description: "In-process API mocking for browser + Node tests. Service Worker in browser; Node interceptor in tests. Free OSS. Used for Vitest unit tests, Storybook stories, and dev-time mocking."
