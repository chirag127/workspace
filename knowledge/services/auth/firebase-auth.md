...
description: "The 6 sign-in providers wired into the family's single Firebase Auth project — Email link, Google, GitHub, Anonymous, Microsoft, Passkeys. Apple deferred until the iOS app ships."
...
- [Multi-provider auth decision (2026-06-20)](../../decisions/security/multi-provider-auth.md)
