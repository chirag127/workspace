...
description: Ship one executable script per setup/host/deploy request. Manual steps = defect
tags: [automation, deployment, hard-rule, user-identity]
timestamp: 2026-06-27
format_version: okf-v0.1
status: active
related:
  - agent-rules/setup-repo-as-bootstrap
  - agent-rules/preferences/scope-cut-only-shipping-survives
---
