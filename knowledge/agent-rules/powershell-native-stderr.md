...
description: Cargo/winget/npm/gcc print to stderr. PS 5.1 + EAP=Stop wraps stderr in RemoteException. Pipe through cmd /c ... 2>&1
tags: [powershell, stderr, automation, hard-rule]
timestamp: 2026-06-27
format_version: okf-v0.1
status: active
related:
  - agent-rules/powershell-ascii-only
