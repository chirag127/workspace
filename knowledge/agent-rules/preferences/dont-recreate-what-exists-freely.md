...
description: Before forking/scaffolding/building: 2 web searches confirming no free OSS equivalent. If exists, use it
...
related:
  ...
  - decisions/fleet/build-gate-top3-must-have-defect
  - agent-rules/preferences/lean-by-need-not-count
---
...
- [`build-gate-top3-must-have-defect`](../../decisions/fleet/build-gate-top3-must-have-defect.md) — build only when top-3 search results have a defect we'd fix
