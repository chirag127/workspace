...
description: Only shipping-content repos survive. In-progress/scaffold/will-build-someday archived. 33 repos cut
...
Generalizes [`build-gate-top3-must-have-defect`](../../../decisions/fleet/build-gate-top3-must-have-defect.md) from features to repos.
