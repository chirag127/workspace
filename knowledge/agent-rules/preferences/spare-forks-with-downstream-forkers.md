...
description: Bulk-deleting forks: spare forks others forked. Downstream fork = real user chose your fork as upstream
...
- [`fs-own-frk-split`](../../../decisions/fleet/fs-own-frk-split.md) — `repos/frk/<slug>/` is where forks we ARE keeping live.
