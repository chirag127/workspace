...
description: Build-gate applies to npm deps as features. No min/max dep count. Each dep justifies itself
...
Related:
- [`build-gate-top3-must-have-defect`](../../../decisions/fleet/build-gate-top3-must-have-defect.md) — the parent rule this generalizes from
