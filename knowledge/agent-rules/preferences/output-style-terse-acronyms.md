...
description: Agent output terse, uses acronyms freely (OKF, MCQ, MCP, LOC, CF, GH, PWA, SERP). Expand only if non-obvious
tags: [agent-behavior, preferences, output-style, communication]
timestamp: 2026-06-26
format_version: okf-v0.1
status: active
related:
  - agent-rules/grill-me-default
  - agent-rules/preferences/mcq-4-options-default
---
