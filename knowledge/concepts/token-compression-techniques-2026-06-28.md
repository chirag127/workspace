...
description: Web-researched survey of context-compression tools, techniques, and built-in agent levers. Source-of-truth for which tools we run, which we evaluated, and which we explicitly rejected. Numbers from independent benchmarks (computingforgeeks, deployhq, official READMEs).
tags: [compression, tokens, headroom, rtk, caveman, mcp, performance, research, agent-tooling]
timestamp: 2026-06-28
format_version: okf-v0.1
status: active
related:
  - concepts/headroom-internals-2026-06-27
  - rules/agent/caveman
...
- [[concepts/headroom-internals-2026-06-27]] — Hr internals
