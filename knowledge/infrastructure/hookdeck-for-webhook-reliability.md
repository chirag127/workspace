...
description: Hookdeck queues Razorpay webhooks. 100K/mo free
...
- Adds Hookdeck to the [services/business/tooling/](../../services/business/tooling/index.md) catalog as an active pick.
- Swap cost is low: switching Hookdeck off means pointing Razorpay's webhook URL back at `api.oriz.in` directly (or fronting it with Cloudflare Queues — see [services/business/tooling/hookdeck.md](../../services/business/tooling/hookdeck.md) alternatives).

## Cross-refs

- [services/business/tooling/hookdeck](../../services/business/tooling/hookdeck.md)
- [services/business/payment/razorpay](../../services/business/payment/razorpay.md)
