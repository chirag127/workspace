...
description: "The user uses speech-to-text software heavily. STT introduces transcription typos and stitched-word artefacts. Agents must: ask short-labelled options (within the 4-question cap); infer intent from imperfect transcription; when ambiguous, pick the most-likely interpretation, state it explicitly, and proceed; ask only when truly blocked. Avoid asking the user to re-transcribe — offer your best read and ask for a tweak."
