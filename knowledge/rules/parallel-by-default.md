...
description: "Any work that can be parallelised MUST be fanned out via subagents. Sequential is the exception, justified when used."
tags: [rules, agent, productivity, subagents]
