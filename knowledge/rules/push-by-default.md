...
description: >-
  Standing authorisation: agents commit AND push to main immediately after
  every change. Removes the prior "no push without explicit user say-so"
  rule. Outward-effect actions still require confirmation.
tags: [rule, git, workflow, autonomy]
