...
description: "When a content-site scope question offers narrow-but-deep vs wide-but-shallow, the user picks wide. Cost: more content to write. Benefit: domain owns a category, not a niche. Apply as default."
...
User chose to own "cards" as a category vs just "credit cards", accepting lower per-page rank for a wider topical net. See [cards-site-scope.md](../decisions/architecture/cards-site-scope.md).
