...
description: "Always Read a file in the current session before calling Edit. The harness enforces this; the rule restates the why so agents don't fight it — it prevents stale-match failures and accidental clobbering."
...
match the surrounding style ([`match-surrounding-style.md`](./match-surrounding-style.md)).
...
- [`match-surrounding-style.md`](./match-surrounding-style.md)
