...
description: "Every chirag127/oriz* repo slug must end in -site, -ext, -vsc-ext, -cli, -worker, -fn, -data — or be a clean npm-package name. Audit the slug before the first push to a new repo."
...
[`runbooks/rename-repo.md`](../runbooks/rename-repo.md) before the
...
- [`runbooks/rename-repo.md`](../runbooks/rename-repo.md) — how to rename safely
