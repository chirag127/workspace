...
description: "One-time prepaid OK, no recurring cards"
...
Knowledge: [`no-card-on-file`](./no-card-on-file.md), and the new [`pwabuilder-as-primary-converter`](../../decisions/frontend/pwabuilder-as-primary-converter.md) which uses both Play + Microsoft + CWS.
