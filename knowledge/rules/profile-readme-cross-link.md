...
description: "The chirag127 GitHub profile README must include a one-line cross-link to oriz-org (the brand org), and the oriz-org profile README must include a 'Founded by Chirag Singhal' line linking back. Both surfaces — personal account and brand org — must lead a visitor to the other in one click."
tags: [rule, branding, recruiter, github, readme, profile]
