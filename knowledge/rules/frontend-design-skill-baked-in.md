...
description: "Permanently baked into knowledge per user mandate 2026-06-22 evening. This is the agent's design philosophy when building or reshaping any UI. Ground design in the subject. Hero is a thesis. Typography carries personality. Structure is information. Motion is deliberate. Match complexity to vision. Avoid AI-cluster defaults. Brainstorm-explore-plan-critique-build-critique-again. Restraint + self-critique (remove one accessory before publishing). Writing is design material — active voice, end-user side of screen, name by what people control."
tags: [rule, design, frontend, distinctive, intentional, agent-philosophy]
