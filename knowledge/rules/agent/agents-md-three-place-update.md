...
description: 'When user asks to add a rule, write the rule to `knowledge/rules/<area>/<name>.md`, add a one-line entry to AGENTS.md table for that subdir, and bump the rules-count in section headers. All three in the same commit.'
...
related:
  ...
  - rules/agent/agents-md-2025-discipline
---
