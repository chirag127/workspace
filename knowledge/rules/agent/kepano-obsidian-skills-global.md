...
description: "Steph Ango's obsidian-skills repo is cloned to ~/skill-sources/ and the five sub-skills are symlinked into ~/.claude/skills/ as obsidian-{defuddle,json-canvas,bases,cli,markdown}. Global, not per-repo."
