...
description: We have Firebase CLI + enough agent context to drive it. No skill wrappers (firebase-firestore, firebase-auth-basics, etc.). Saves context, kills documentation rot.
