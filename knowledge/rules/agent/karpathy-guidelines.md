...
description: ACTIVE every coding task. State assumptions before acting. Surface ambiguity via MCQ. Clean imports you orphaned. Define success criteria + loop. Rest overlaps with Ponytail/Minimum — cross-ref those.
