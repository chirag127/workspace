...
description: PS 5.1 without UTF-8 BOM reads files as Windows-1252. Em-dashes (U+2014) and smart quotes break the parser. Use ASCII hyphens and straight quotes in all .ps1 files we ship.
