...
description: All fleet agents (Claude Code, OpenCode, Kilo Code, Antigravity) must see the same workspace rules and MCP servers. Sync via scripts/sync-mcp-configs.mjs and the `.agents/<agent>/AGENTS.md` pointer pattern. No agent gets a private rule set.
...
| Excluded | Why |
|---|---|
| Cline | Dropped 2026-06-29 — overlaps Kilo Code (both VS Code, both MCP-native); avoids duplicate sync target. See [`fleet-cut-to-4-agents-2026-06-29`](../../decisions/architecture/agent-tooling/fleet-cut-to-4-agents-2026-06-29.md). |
...
- [`fleet-cut-to-4-agents-2026-06-29`](../../decisions/architecture/agent-tooling/fleet-cut-to-4-agents-2026-06-29.md) — Cline-drop decision
