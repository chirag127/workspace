...
description: Never propose adding a second remote (chirag127, backup, mirror) to forks. The oriz-org fork on GitHub is the backup. Stop re-asking.
...
related:
  ...
  - decisions/architecture/ops/backup-restic-b2-plus-windows-builtin
---
...
B2 — already locked in `decisions/architecture/ops/backup-restic-b2-plus-windows-builtin`).
