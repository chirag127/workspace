...
description: ".mcp.json is the canonical MCP server config. All 5 agents sync from it via scripts/sync-mcp-configs.mjs. Never edit per-agent configs directly."
tags: [mcp, config, agents, sync, infrastructure]
timestamp: 2026-06-29
format_version: okf-v0.1
status: active
related:
  - decisions/architecture/infrastructure/mcp-config-sync-2026-06-29
---
...
- The grill decision that locked this: `knowledge/decisions/architecture/infrastructure/mcp-config-sync-2026-06-29.md`
