...
description: "When filing an external issue/PR claiming a gap, every 'project X has/doesn't have Y' assertion must be backed by a Read of the source file — not a grep alone."
