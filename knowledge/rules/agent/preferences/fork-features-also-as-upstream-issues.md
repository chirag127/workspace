...
description: Feature patched in repos/frk/ ? file upstream issue requesting same. If merged, drop patch
...
**Related:** [`fs-own-frk-split`](../../../decisions/fleet/fs-own-frk-split.md) (forks live in `repos/frk/`), [`scope-cut-2026-06-25`](../../../decisions/fleet/scope-cut-2026-06-25.md) (only patch features you actually ship today).
