...
description: Prefer renaming local folder over renaming GitHub repo. GitHub repo names = brand identity
...
**Related:** [`fs-own-frk-split`](./fs-own-frk-split.md), [`repo-names-drop-oriz-prefix`](../../../branding/repo-names-drop-oriz-prefix.md), [`repo-slug-suffix-npm-pkg`](./repo-slug-suffix-npm-pkg.md).
