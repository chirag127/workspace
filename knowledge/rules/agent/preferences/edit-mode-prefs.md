...
description: Edit > Write, batch parallel tool calls, task-list tool for ≥3 steps, no .md deliverables.
...
- **Batch independent tool calls** in one turn (parallel function calls in same response). See [`parallel-by-default`](../../interaction/parallel-by-default.md).
