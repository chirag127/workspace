...
description: "Cloudflare's workerd runtime does not fully support gRPC, which firebase-admin requires. Use firebase-rest-firestore (REST + Web SDK) instead inside any Worker."
tags: [rules, cloudflare, workers, firebase, gRPC, runtime]
...
- [`api-umbrella-hono-worker.md`](../architecture/api-umbrella-hono-worker.md)
