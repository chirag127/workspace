...
description: "pnpm is mandatory across the oriz family. Its content-addressable global store at ~/.pnpm-store is what makes the 'no duplication' goal achievable when 11+ sites share dependencies."
tags: [rule, pnpm, package-manager, tooling, no-duplication]
