...
description: "When chat contradicts a knowledge file or AGENTS.md, the chat wins; the file is updated in the same turn."
...
- [`self-update-rule.md`](./self-update-rule.md) — paired rule
