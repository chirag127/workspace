...
description: "When editing existing files, match the file's existing comment density, naming idioms, semicolon use, and import order. Don't impose a new style mid-file."
tags: [rules, style, code-review, consistency]
timestamp: 2026-06-20
format_version: okf-v0.1
status: active
related:
  - rules/read-before-edit
  - rules/no-emoji-in-chrome
---
...
- [`read-before-edit.md`](./read-before-edit.md)
