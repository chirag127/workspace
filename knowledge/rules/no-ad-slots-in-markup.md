...
description: "Don't reserve empty `<div class=\"ad-slot\">` boxes in HTML. AdSense, Ezoic, and Mediavine inject ads at runtime around organic content — pre-reserved slots hurt CLS, layout, and ad fill rate."
tags: [rules, ads, monetisation, layout, design]
