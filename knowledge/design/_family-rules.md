...
description: "The cross-site design contract: surface distribution, typeface budget, accent colour distribution, no-compromise briefs, and universal constraints across all 11 oriz-* sites."
