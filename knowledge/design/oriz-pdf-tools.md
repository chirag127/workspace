...
description: "Typesetter's desk for documents: cream manuscript surface, all-serif type stack (even buttons), ledger-green CTAs, vermilion reserved for redaction/destructive actions."
